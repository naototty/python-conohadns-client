...
from conohadnsclient.functionaltests.config import cfg
from conohadnsclient.functionaltests.models import FieldValueModel
from conohadnsclient.functionaltests.models import ListModel
    ...
    def _init_clients(cls):
        cls._CLIENTS = {
            'default': DesignateCLI(
                cli_dir=cfg.CONF.conohadnsclient.directory,
